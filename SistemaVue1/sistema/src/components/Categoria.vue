    ...
    <v-layout align-start>
        <v-flex>
                ...
                <v-card>
                    ...
                    <v-container grid-list-md>
                        ...
                        <v-flex xs12 sm6 md4>
                         ...
                         <v-flex xs12 sm6 md4>
                            <v-text-field v-model="editedItem.calories" label="Nombre"></v-text-field>
                        </v-flex>
                        <v-flex xs12 sm6 md4>
                            <v-text-field v-model="editedItem.calories" label="Apellido"></v-text-field>
                        </v-flex>
                        <v-flex xs12 sm6 md4>
                            <v-text-field v-model="editedItem.fat" label="DPI"></v-text-field>
                        </v-flex>
                        <v-flex xs12 sm6 md4>
                        ...
                        <v-flex xs12 sm6 md4>
                            <v-text-field v-model="editedItem.protein" label="direccion"></v-text-field>
                        </v-flex>
                        </v-layout>
                    </v-container>
                    </v-card-text>
            ...
            >
                ...
                <td class="text-xs-right">{{ props.item.DPI }}</td>
